...
\begin{document}
\date{April 23th 2014\\ IT University of Copenhagen}
\title{Homographies and Augmentation\\SIGB Spring 2014}
...
A recorded sequence, showcasing animations, transformations and alternative objects, can be found on the enclosed DVD in a file called 'animated\_alternative\_objects.mp4' \todo{lav den video og gem den ;o)}
