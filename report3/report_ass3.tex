...
As shown in Figure \ref{fig:full_shading}, Phong shading achieves a quite realistic shading. \emph{phong\_shading.avi} on the DVD shows a sequence shaded by our implementation of Phong shading.
